...
.follow img{width:180px;margin-top:10px;}
	...
	<div style="padding:15px 15px;height:80px;"><a class="ui-btn-lg ui-btn-danger" href="http://www.nsw88.com/huodong" target="_blank">更多装逼功能>></a></div>
</div>
<footer class="ui-footer ui-footer-btn">
	<ul class="ui-tiled ui-border-t">
		<li class="ui-border-r"><a href="../huodong"><div>装逼首页</div></a></li>
...
<div id="follow" class="follow">
	...
	<p>关注我们有更多惊喜</p>
	<p>长按识别图中二维码</p>
	<img src="http://open.weixin.qq.com/qr/code/?username=gh_5bb1bd81c1fb">
</div>
