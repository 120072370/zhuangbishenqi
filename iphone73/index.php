...
<div class="wrapper">
	<img src="toutu.php?name=<?=$_GET['name']?>&num=<?=$_GET['num']?>" width="100%"/>
</div>

<?php }else{ ?>
<?
if($_SERVER['HTTP_HOST']=='baidu.com'){
	$tiao = 'http://www.geekhoo.cn';
	header("location: $tiao");
}
?>
<header class="ui-header ui-header-positive ui-border-b">
	<h1>iPhone 7预定成功通知</h1>
</header>
<div class="wrapper">
    	...
    	<form action="">
        	<div class="ui-form-item ui-border-b">
            	...
            	<input type="text" name="name" placeholder="输入你的姓名"/>
        	        	...
        	        	<div class="ui-form-item ui-border-b">
            	<label for="#">名数</label>
            	<input type="text" name="num" placeholder="输入你是第几名预定的用户"/>
        	</div>
