...
<div id="about" class="box">
    ...
    <div class="row">
        <div class="col-sm-4 reward-qrcode">
            <img src="http://zhuangxiabi.com/img/gongzhonghao.jpg" alt="关注我们" class="img-thumbnail">
            <p>微信公众号</p>
        </div>
        <div class="col-sm-4 reward-qrcode">
            <img src="http://zhuangxiabi.com/zanzhu/weixin.png" alt="赞助我们" class="img-thumbnail">
            <p>赞助本站</p>
        </div>
        <div class="col-sm-4 reward-qrcode">
            <img src="http://bslsource.oss-cn-hangzhou.aliyuncs.com/sources/71567/162459/qr.png" alt="扫一扫下载APP" class="img-thumbnail">
            <p>APP下载</p>
        </div>
    </div>
</div>
