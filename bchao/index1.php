...
<div class="wrapper">
	<img src="toutu.php?name=<?=$_GET['name']?>&xingbie=<?=$_GET['xingbie']?>" width="100%"/>
</div>
...
<div class="wrapper"><br>
	...
	<div class="ui-form">
    	<form action="">
        	...
        	<div class="ui-form-item ui-border-b">
            	<label>性别</label>
            	<input type="text" name="xingbie"  maxlength="20"                   placeholder="输入性别如：女" style="font-size:18px;"/>
        	</div>
