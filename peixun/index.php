...
<title>职业培训证书生成器_<?php include('../mc.php');?></title>
...
<div class="wrapper">
	<img src="bjlm123.taobao.com.php?name=<?=$_GET['name']?>&id=<?=$_GET['id']?>" width="100%"/>
</div>
<?php  include("../ad.php");?>
<?php }else{ ?>

<header class="ui-header ui-header-positive ui-border-b">
<h1>职业培训证书生成器</h1></header>
<div class="wrapper">
...
<div class="ui-form-item ui-border-b">
            	...
            	<div class="ui-select">
                	<select name="id">
                    	<option value ="鉴黄师">鉴黄师</option>
                    	<option value ="催乳师">催乳师</option>
						<option value ="月嫂">月嫂</option>
						<option value ="安全套试用员">安全套试用员</option>
						<option value ="避孕套试用员">狗粮品尝师</option>
                	</select>
            	</div>
        	</div>
