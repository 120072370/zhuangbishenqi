	...
	<div class="ui-form">
    	<form action="">
        	<div class="ui-form-item ui-border-b">
            	<label>名字</label>
            	<input type="text" name="name"  maxlength="20"                   placeholder="注意控制字数" style="font-size:18px;"/>
        	</div>
        	<div class="ui-form-item ui-border-b">
            	<label>输入第一行</label>
            	<input type="text" name="nameb"  maxlength="20"            placeholder="注意控制字数" style="font-size:18px;"/>
        	</div>
        	<div class="ui-form-item ui-border-b">
            	<label>输入第二行</label>
            	<input type="text" name="namec"  maxlength="20"            placeholder="注意控制字数" style="font-size:18px;"/>
        	</div>
