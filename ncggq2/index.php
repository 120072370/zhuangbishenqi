	...
	<div class="ui-form">
    	<form action="">
        	<div class="ui-form-item ui-border-b">
            	<label>联系人</label>
            	<input type="text" name="name"  maxlength="20"                   placeholder="输入联系人如：王二狗" style="font-size:18px;"/>
        	</div>
        	<div class="ui-form-item ui-border-b">
            	<label>联系电话</label>
            	<input type="text" name="nameb"  maxlength="20"            placeholder="输入电话如：13888888888" style="font-size:18px;"/>
        	</div>
