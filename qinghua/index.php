...
<title>清华大学录取通知书生成器_<?php include('../mc.php');?></title>
...
<div class="wrapper">
	<img src="bjlm123.taobao.com.php?name=<?=$_GET['name']?>&namea=<?=$_GET['namea']?>&nameb=<?=$_GET['nameb']?>" width="100%"/>
</div>
<?php  include("../ad.php");?>
<?php }else{ ?>
<?
