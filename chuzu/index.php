	...
	<div class="ui-form">
    	<form action="">
        	<div class="ui-form-item ui-border-b">
            	<label for="#">名字</label>
            	<input type="text" name="name"  maxlength="20"                   placeholder="输入你的名字" style="font-size:18px;"/>
        	</div>
        	<div class="ui-form-item ui-border-b">
            	<label for="#">微信</label>
            	<input type="text" name="nameb" placeholder="输入你的微信"style="font-size:18px;"/>
        	</div>
