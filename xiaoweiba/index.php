	...
	<div class="ui-form">
    	<form action="">
        	<div class="ui-form-item ui-border-b">
            	<label for="#">来自</label>
            	<input type="text" name="name"  maxlength="20"                  value="iPhone 8S plus" placeholder="iPhone 7 plus" style="font-size:18px;"/>
        	</div>
