...
<div class="wrapper">
	<img src="www.at168.com.php?id=<?=$_GET['id']?>&name=<?=$_GET['name']?>" width="100%"/>
</div>
<?php  include("../ad.php");?>
<?php }else{ ?>
<?
	...
	<div class="ui-form">
    	<form action="">
        	<div class="ui-form-item ui-border-b">
            	<label for="#">姓名</label>
            	<input type="text" name="name" placeholder="输入姓名"  maxlength="3"/>
        	</div>
			<div class="ui-form-item ui-border-b">
            	<label>城市</label>
            	<div class="ui-select">
                	<select name="id">
                    	<option value ="1">免费让你玩三天</option>
                    	<option value ="2">几天没来好想你</option>
						<option value ="3">你丫到底行不行</option>
						<option value ="4">不发红包整死你</option>
                	</select>
            	</div>
        	</div>
