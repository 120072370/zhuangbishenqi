	...
	<div class="ui-form">
    	<form action="">
        	<div class="ui-form-item ui-border-b">
            	<label>对方名字</label>
            	<input type="text" name="name"  maxlength="20"                   placeholder="输入对方名字如：李晓花" style="font-size:18px;"/>
        	</div>
        	<div class="ui-form-item ui-border-b">
            	<label>自己名字</label>
            	<input type="text" name="nameb"  maxlength="20"            placeholder="输入自己名字如：王二狗" style="font-size:18px;"/>
        	</div>
