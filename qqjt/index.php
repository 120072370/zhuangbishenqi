	...
	<div class="ui-form">
    	<form action="">
        	<div class="ui-form-item ui-border-b">
            	<label for="#">球球ID</label>
            	<input type="text" name="name"  maxlength="20"                  placeholder="输入球球ID如：暴走大侠666" style="font-size:18px;"/>
        	</div>
        	<div class="ui-form-item ui-border-b">
            	<label>本轮昵称</label>
            	<input type="text" name="nameb"  maxlength="20"                 placeholder="输入本轮昵称如：暴走：浪单不合作" style="font-size:18px;"/>
        	</div>
