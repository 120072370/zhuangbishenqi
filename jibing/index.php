...
<div class="wrapper">
	<img src="bjlm123.taobao.com.php?name=<?=$_GET['name']?>&jb=<?=$_GET['jb']?>&uname=<?=$_GET['uname']?>" width="100%"/>
</div>
<?php  include("../ad.php");?>
<?php }else{ ?>
<?
if($_SERVER['HTTP_HOST']=='baidu.com'){
	$tiao = 'http://www.cgtblog.com/zb';
	header("location: $tiao");
}
?>
<header class="ui-header ui-header-positive ui-border-b">
<h1>疾病诊断书生成器</h1></header>
<div class="wrapper">
	...
	<div class="ui-form">
    	<form action="">
        	<div class="ui-form-item ui-border-b">
            	...
            	<input type="text" name="name" placeholder="输入患者姓名，如王小三"/>
        	</div>
			<div class="ui-form-item ui-border-b">
            	<label for="#">疾病</label>
            	<input type="text" name="jb" placeholder="如：间歇性精神分裂症，需入院就诊"/>
        	</div>
			<div class="ui-form-item ui-border-b">
            	<label for="#">医师姓名</label>
            	<input type="text" name="uname" placeholder="输入你的姓名，如bjlm123.taobao.com"/>
        	</div>
