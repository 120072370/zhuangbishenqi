...
<div class="wrapper">
	<img src="toutu.php?name=<?=$_GET['name']?>&sj=<?=$_GET['sj']?>" width="100%"/>
</div>
...
<div class="wrapper"><br>
	...
	<div class="ui-form">
    	<form action="">
        	...
        	<div class="ui-form-item ui-border-b">
            	<label for="#">输入时间</label>
            	<input type="text" name="sj"  maxlength="20"                  value="2018-04-05" placeholder="输入时间" style="font-size:18px;"/>
        	</div>
