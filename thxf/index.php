	...
	<div class="ui-form">
    	<form action="">
        	<div class="ui-form-item ui-border-b">
            	<label>第一行</label>
            	<input type="text" name="name"  maxlength="20"                   placeholder="最多输入6个字" style="font-size:18px;"/>
        	</div>
        	<div class="ui-form-item ui-border-b">
            	<label>第二行</label>
            	<input type="text" name="nameb"  maxlength="20"            placeholder="最多输入6个字" style="font-size:18px;"/>
        	</div>
