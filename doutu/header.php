...
<div class="collapse navbar-collapse" id="my-navbar-collapse">
    <ul class="nav navbar-nav">
        ...
        <li<?php echo $myactive[1]; ?>>
            <a href="<?php echo C('siteurl'); ?>/doutu/index.php" title="我的表情，自己造">
                表情制作
            </a>
        </li>
        
        <li<?php echo $myactive[5]; ?>>
            <a href="<?php echo C('siteurl'); ?>" title="无形装逼，最为致命">
                装逼神器
            </a>
        </li>
        
        <li<?php echo $myactive[3]; ?>>
            <a href="<?php echo C('siteurl'); ?>/doutu/rand.php" title="你要的，都在这">
                表情大全
            </a>
        </li>
        
        <li<?php echo $myactive[4]; ?>>
            <a href="<?php echo C('siteurl'); ?>/doutu/topic.php" title="终于可以一次打包下载所有的表情了！">
                表情专题
            </a>
        </li>
        
        <li<?php echo $myactive['search']; ?>>
            <a href="<?php echo C('siteurl'); ?>/doutu/search.php" title="想要什么表情图？尽管搜！">
                表情搜索
            </a>
        </li>
        
        <li<?php echo $myactive[2]; ?>>
            <a href="<?php echo C('siteurl'); ?>/doutu/about.php" title="装了逼，还想跑？">
                关注我们
            </a>
        </li>
        <!--导航栏链接结束-->
...
<div class="copyright">
    <div class="container text-center">
        <span>
            Copyright &copy; <a href="<?php echo C('siteurl'); ?>"><?php echo C('webTitle') ?></a>
        </span> |
        <span>
...
var cnzz_protocol = (("https:" == document.location.protocol) ? " https://" : " http://");document.write(unescape("%3Cspan id='cnzz_stat_icon_1258001701'%3E%3C/span%3E%3Cscript src='" + cnzz_protocol + "s11.cnzz.com/z_stat.php%3Fid%3D1258001701%26show%3Dpic' type='text/javascript'%3E%3C/script%3E"));
</script><!--站长统计代码（您可以将这里的代码改为您自己的站点统计代码）-->
