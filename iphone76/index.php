...
<title>Apple Store 订单iphone7生成</title>
...
<div class="wrapper">
	<img src="toutu.php?name=<?=$_GET['name']?>&youxiang=<?=$_GET['youxiang']?>" width="100%"/>
</div>

<?php }else{ ?>
<header class="ui-header ui-header-positive ui-border-b">
	<h1>Apple Store 订单iphone7生成</h1>
</header>
<div class="wrapper"><br>
	...
	<div class="ui-form">
    	<form action="">
        	...
        	<div class="ui-form-item ui-border-b">
            	<label>ID邮箱</label>
            	<input type="text" name="youxiang"  maxlength="20"                   placeholder="输入ID邮箱如：123456@qq.com" style="font-size:18px;"/>
        	</div>
