...
<div class="wrapper">
	<img src="www.at168.com.php?name=<?=$_GET['name']?>&id=<?=$_GET['id']?>元" width="100%"/>
</div>
<?php  include("../ad.php");?>
<?php }else{ ?>
<?
...
<div class="wrapper">
	<img src="icon.jpg" width="50%" style="margin:10px 25% 10px 25%;"/>
	<div class="ui-form">
    	<form action="">
			...
			<div class="ui-form-item ui-border-b">
            	<label>金额</label>
            	<input type="text" name="id" placeholder="输入金额">
        	</div>
