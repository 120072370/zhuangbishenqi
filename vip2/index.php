	...
	<body>
			        ...
			        <span class="icon-bar"></span>
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav">
								<li>
									<a href="http://www.zhuangxiabi.com" target="_blank">官方网站</a>
								</li>
								<li>
									<a href="http://zhuangxiabi.com/vip" target="_blank"> <span class="badge" style="background: red;margin-right:5px ;">HOT</span>老鱼影院<span class="sr-only">(current)</span></a>
								</li>
								<li>
									<a href="/zhibo">电视直播</a>
								</li>
							...
							<ul class="nav navbar-nav navbar-right">
								...
								<li class="dropdown">
									...
									<ul class="dropdown-menu">
										<li>
											<a href="http://www.zhuangxiabi.com" target="_blank" title="装逼神器（zhuangxiabi.com)">装逼神器</a>
										</li>
										<li>
											<a href="/zhibo" target="_blank" title="高清电视在线直播">电视直播</a>
										</li>
									</ul>
								</li>
								<li>
									<a href="http://www.appbsl.com/index.php?ctl=app_download&code=qbS8hqO8tLTcxNTY3LS0wA%3D%3D" target="_blank">客户端</a>
								</li>
							</ul>
						</div>
					</div>
		...
		<div class="container-fluid video-box">
			<div class="container ">
				<div class="tit-name">
					<span>正在播放:</span>
					<h1 id="tittext">感谢您使用老鱼视频解析服务,正在播放音乐MV视频！</h1>
				</div>
				...
				<div class="url-box">
					<div class="input-group">
						<input type="text" id="url" class="form-control url-text" aria-label="Text input with segmented button dropdown" placeholder="请复制粘贴视频播放页地址到此>" title="请复制你想要看的视频网址，粘贴到此处点击播放即可！">
						...
						<div class="input-group-btn">
							...
							<button type="button" class="btn btn-default btn-play" title="点击开始解析并开始播放" onclick="play()">开始播放</button>
						</div>
					</div>
		...
		<script>
			console.log("%c%c源码作者%c北漂鱼，优化修改%c老鱼", "line-height:28px;", "line-height:28px;padding:4px;background:#222;color:#FADFA3;font-size:14px;", "padding:4px;background:#FADFA3;color:#000;line-height:28px;font-size:14px;");
			console.log("%c%c网站地址%chttp://www.zhuangxiabi.com", "line-height:28px;", "line-height:28px;padding:4px;background:#222;color:#FADFA3;font-size:14px;", "padding:6px 6px 6px 2px;background:#FADFA3;color:#0093fff;line-height:28px;font-size:12px;");
			console.log("%c%c新浪微博%c我要寻狗网", "line-height:28px;", "line-height:28px;padding:4px;background:#222;color:#FADFA3;font-size:14px;", "padding:4px;background:#FADFA3;color:red;line-height:28px;font-size:14px;");
			console.log("%c%c就知道阻挡不住你观看源码的冲动，但你至少要记住我！-----老鱼", "line-height:28px;", "line-height:28px;padding:4px 0px;color:#fff;font-size:16px;background-image:-webkit-gradient(linear,left top,right top,color-stop(0,#ff22ff),color-stop(1,#5500ff));color:transparent;-webkit-background-clip:text;");
		</script>
