				...
				<table width="90%"  align="center" cellpadding="5" cellspacing="1" class="tablecss" >
					...
					<tr>
					  ...
					  <td width="690" valign="middle">
					  	...
					  	<span class="gray tips">如：老鱼影院</span>
					  </td>
					</tr>
					<tr>
					    ...
					    <td width="690" valign="middle">
					      ...
					      <span class="gray tips">网站域名，如 http://tv.zhuangxiabi.com </span>
					    </td>
					</tr>
					<tr>
					...
					<tr>
					    ...
					    <td valign="top">请将解析接口分别填入下列空中<font color="red">（第一条是默认调用接口）</font><div class="cl5"></div>
							...
							<input type="text" name="aik[jiekou11name]" class="shuru" placeholder="名称：" value="<?php echo $aik['jiekou11name']?>" size=20" ><input type="text" name="aik[jiekou11]" placeholder="接口url：" class="shuru" value="<?php echo $aik['jiekou11']?>" size="80" ><br/>
							<input type="text" name="aik[jiekou12name]" class="shuru" placeholder="名称：" value="<?php echo $aik['jiekou12name']?>" size=20" ><input type="text" name="aik[jiekou12]" placeholder="接口url：" class="shuru" value="<?php echo $aik['jiekou12']?>" size="80" ><br/>
							<input type="text" name="aik[jiekou13name]" class="shuru" placeholder="名称：" value="<?php echo $aik['jiekou13name']?>" size=20" ><input type="text" name="aik[jiekou13]" placeholder="接口url：" class="shuru" value="<?php echo $aik['jiekou13']?>" size="80" ><br/>
							<input type="text" name="aik[jiekou14name]" class="shuru" placeholder="名称：" value="<?php echo $aik['jiekou14name']?>" size=20" ><input type="text" name="aik[jiekou14]" placeholder="接口url：" class="shuru" value="<?php echo $aik['jiekou14']?>" size="80" ><br/>
							<input type="text" name="aik[jiekou15name]" class="shuru" placeholder="名称：" value="<?php echo $aik['jiekou15name']?>" size=20" ><input type="text" name="aik[jiekou15]" placeholder="接口url：" class="shuru" value="<?php echo $aik['jiekou15']?>" size="80" ><br/>
					    </td>
					</tr>
					<tr>
